 ...
 * True(1), False(0)
 *
 *  AND &&  → 곱  true x true → true // true x false → false  // false x false → false   하나라도 거짓이면 무조건 거짓
 *  OR ||   → 합  true + true → true // true + false → true // false + false → false     하나라도 참이면 무조건 참
 *  NOT !   → 부정  서로의 부정은 서로가 된다.
 */
public class Operation2 {
    public static void main(String[] args) {
        ...
        System.out.println("T + F x T =>" + result7);  // && 연산이 우선순위가 높다.
